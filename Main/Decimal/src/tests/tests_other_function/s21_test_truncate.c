...
TCase *s21_TruncateTCase() {
  TCase *tcase = tcase_create("s21_TruncateTCase");

  tcase_add_test(tcase, test_truncate_fail1);
  tcase_add_test(tcase, test_truncate_fail2);
  tcase_add_test(tcase, test_truncate_fail3);
  tcase_add_test(tcase, test_truncate_fail4);
  tcase_add_test(tcase, test_truncate_fail5);
  tcase_add_test(tcase, test_truncate_fail6);
  tcase_add_test(tcase, test_truncate_fail7);
  tcase_add_test(tcase, test_truncate_fail8);
  tcase_add_test(tcase, test_truncate_fail9);

  tcase_add_test(tcase, test_truncate_ok1);
  tcase_add_test(tcase, test_truncate_ok2);
  tcase_add_test(tcase, test_truncate_ok3);
  tcase_add_test(tcase, test_truncate_ok4);
  tcase_add_test(tcase, test_truncate_ok5);
  tcase_add_test(tcase, test_truncate_ok6);
  tcase_add_test(tcase, test_truncate_ok7);
  tcase_add_test(tcase, test_truncate_ok8);
